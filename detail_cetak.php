...
<head>
	...
	<link href="assets/images/ikonmobil4.jpg" rel="icon" type="images/x-icon">
				...
				<tbody>
					<tr>
						<td rowspan="3" width="16%" class="text-center">
							<img src="assets/images/ikonmobil4.jpg" alt="logo-dkm" width="80" />
						</td>
						<td class="text-center"><h1>Car Rent</h1></td>
						<td rowspan="3" width="16%">&nbsp;</td>
					</tr>
					<tr>
						<td class="text-center">Jl. Taman Malaka Selatan No.20, RT.8/RW.6, Pd. Klp., Kec. Duren Sawit, Kota Jakarta Timur, Daerah Khusus Ibukota Jakarta 13450</td>
					</tr>
				</tbody>
			</table>
			<hr class="line-top" />
		...
		<div class="container-fluid">
			...
			<table class="table table-borderless">
				<tbody>
					...
					<tr>
						<td>Tanggal Mulai Rental</td>
						<td>:</td>
						<td><?php echo IndonesiaTgl($result['tgl_mulai']);?></td>
					</tr>
					<tr>
						<td>Tanggal Selesai Rental</td>
						<td>:</td>
					...
					<tr>
						<td>Total Biaya Mobil (<?php echo $result['durasi'];?>) Hari</td>
						<td>:</td>
						<td><?php echo format_rupiah($totalmobil);?></td>
					</tr>
					<tr>
						<td>Total Biaya Driver (<?php echo $result['durasi'];?>) Hari</td>
						<td>:</td>
						<td><?php echo format_rupiah($drivercharges);?></td>
					</tr>
					<tr>
						<td>Total Keseluruhan Biaya Rental (<?php echo $result['durasi'];?>) Hari</td>
						<td>:</td>
