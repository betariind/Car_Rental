...
<title>Car Rent Portal | Booking Mobil</title>
<!--Bootstrap -->
        ...
        <form method="post" name="sewa" onSubmit="return valid();"> 
			...
			<label>Metode PickUp</label><br/>
				<select class="form-control" name="pickup" required>
					...
					<option value="Ambil Sendiri">Datang ke tempat</option>
					<option value="Pickup Sesuai Alamat">Diantar ke rumah</option>
				</select>
            </div>
            <div class="form-group">
			<label>Dengan Driver</label><br/>
