...
<title>Car Rent Portal | Detail Sewa</title>
<!--Bootstrap -->
...
<section class="user_profile inner_pages">
	...
	<div class="user_profile_info">	
        ...
        <form method="post" action="update_sewa.php" name="sewa" onSubmit="return valid();" enctype="multipart/form-data"> 
            ...
            <div class="form-group">
			<label>Totak Biaya Driver (<?php echo $durasi;?> Hari)</label><br/>
            ...
            <div class="form-group">
			<label>Total Keseluruhan Biaya Rental (<?php echo $durasi;?> Hari)</label><br/>
