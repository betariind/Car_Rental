...
<title>Car Rent Portal | Mobil Tersedia</title>
<!--Bootstrap -->
...
<div>
	<br/>
	<center><h3>Mobil Tersedia </h3></center>
...
?>
<div>
	<center><p>Berikut rincian yang akan dirental</p></center>
</div>
	...
	<div class="user_profile_info">	
        ...
        <form method="post" name="sewa" onSubmit="return valid();"> 
            ...
            <div class="form-group">
			<label>Total Biaya Mobil (<?php echo $durasi;?> Hari)</label><br/>
				<input type="text" class="form-control" name="biayamobil" value="<?php echo format_rupiah($totalmobil);?>"readonly>
            </div>
            <div class="form-group">
			<label>Total Biaya Driver (<?php echo $durasi;?> Hari)</label><br/>
            ...
            <div class="form-group">
			<label>Total Keseluruhan Biaya Rental</label><br/>
