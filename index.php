...
<title>Car Rent Portal | Home</title>
<!--Bootstrap -->
...
<link href="assets/css/font-awesome.min.css" rel="stylesheet">
		...
		<link rel="alternate stylesheet" type="text/css" href="assets/switcher/css/blue2.css" title="blue" media="all" data-default-color="true" />
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
            <h1>SOLUSI UNTUK KEMUDAHAN ANDA!</h1>
            <p>Dengan banyak rekomendasi sesuai keinginan anda. </p>
    ...
    <div class="row"> 
      ...
      <div class="recent-tab">
        <ul class="nav nav-tabs" role="tablist">
          <li role="presentation" class="active"><a href="#resentnewcar" role="tab" data-toggle="tab">Rekomendasi Mobil</a></li>
        </ul>
      </div>
